...
trigger2 = p2stateno != [5110,5150]
;WARUNEK
triggerall = stateno = 222 && time > 9 && movecontact
...
trigger2 = p2stateno != [5110,5150]
;WARUNEK
triggerall = stateno = 212 && time > 11 && movecontact
triggerall = var(38) = 0
...
trigger2 = p2stateno != [5110,5150]
;WARUNEK
triggerall = stateno = 211 && time > 11 && movecontact
triggerall = var(38) = 0
...
trigger2 = p2stateno != [5110,5150]
;WARUNEK
triggerall = stateno = 204 && time > 14 && movecontact
triggerall = var(38) = 0
...
trigger2 = p2stateno != [5110,5150]
;WARUNEK
triggerall = stateno = 203 && time > 11 && movecontact
triggerall = var(38) = 0
...
trigger2 = abs((p2dist x/((p2dist y+1)+ifelse(p2statetype=C,0,-10)))*10) = [10,30]
...
trigger2 = abs((p2dist x/((p2dist y+1)+ifelse(p2statetype=C,0,-10)))*10) = [15,25]
...
trigger2 = var(50) = 1
trigger2 = p2dist x > 100
trigger2 = random = [0,1+(var(49)*(var(49))/200)+(p2bodydist x-100)/40+((4000-power)/400)+ifelse(p2stateno=70500,5,0)]
;WARUNEK
triggerall = ((pos y = 0 && statetype = S)) && ctrl
