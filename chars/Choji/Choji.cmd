...
trigger2 = p2dist y = [-50,50]
trigger2 = random = [680,685+var(49)*(var(49))/100+var(48)/200]
trigger2 = var(50) = 1
trigger2 = p2stateno != [5110,5150]
;WARUNEK
...
trigger2 = random = [660,665+var(49)*(var(49))/100+var(48)/200]
trigger2 = var(50) = 1
trigger2 = p2stateno != [5110,5150]
;WARUNEK
triggerall = (stateno = 504 && time >= 10) || stateno = [502,503]
...
trigger2 = p2dist y = [-100,50]
trigger2 = random = [640,645+var(49)*(var(49))/100+var(48)/200]
trigger2 = var(50) = 1
trigger2 = p2stateno != [5110,5150]
;WARUNEK
triggerall = (stateno = 504 && time >= 10) || stateno = [502,503]
...
trigger2 = p2dist y = [-100,50]
trigger2 = random = [620,625+var(49)*(var(49))/100+var(48)/200]
trigger2 = var(50) = 1
trigger2 = p2stateno != [5110,5150]
;WARUNEK
triggerall = (stateno = 504 && time >= 10) || stateno = [502,503]
...
trigger2 = p2stateno != [5110,5150]
;WARUNEK
triggerall = (pos y != 0 && statetype = A && ctrl) || (var(48) >= 0 && pos y != 0 && statetype = A && movecontact && stateno = [200,289]) 
triggerall = stateno != [214,215]
triggerall = pos y < -50
triggerall = power >= 1000
...
trigger2 = p2dist x = [-50,120]
trigger2 = p2dist y = [-50,50]
trigger2 = random = [380,381+var(49)*(var(49))/500+var(48)/200]
trigger2 = var(50) = 1
trigger2 = p2stateno != [5110,5150]
;WARUNEK
trigger1 = stateno = 70850 && time > cond(prevstateno=0,5,0) && (pos y = 0 && statetype != A)
