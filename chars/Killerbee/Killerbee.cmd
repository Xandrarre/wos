...
triggerall =0; var(1) < 7
trigger1 = stateno = 70850 && time > cond(prevstateno=0,5,0)
trigger2 = (var(50) = 1 && ctrl); || (var(48) >= 0 && var(50) = 1 && movecontact && stateno = [200,295]) 
...
trigger2 = p2stateno != [5110,5150]
;WARUNEK
triggerall = stateno = 251 && time > 16 && movecontact
...
trigger2 = p2stateno != [5110,5150]
;WARUNEK
triggerall = stateno = 243 && time > 2 && movecontact
...
trigger2 = p2stateno != [5110,5150]
;WARUNEK
triggerall = stateno = 231 && time > 20 && movecontact
...
trigger2 = p2stateno != [5110,5150]
;WARUNEK
triggerall = (stateno = 223 && time > 20 && movecontact) || stateno = 224
...
trigger2 = p2stateno != [5110,5150]
;WARUNEK
triggerall = stateno = 222 && time > 16 && movecontact
...
trigger2 = p2stateno != [5110,5150]
;WARUNEK
triggerall = stateno = 221 && time > 2 && movecontact
...
trigger2 = p2stateno != [5110,5150]
;WARUNEK
triggerall = stateno = 220 && time > 2 && movecontact
...
trigger2 = p2stateno != [5110,5150]
;WARUNEK
triggerall = stateno = 212 && time > 2 && movecontact
...
trigger2 = p2stateno != [5110,5150]
;WARUNEK
triggerall = stateno = 203 && time > 2 && movecontact
...
trigger2 = p2stateno != [5110,5150]
;WARUNEK
triggerall = stateno = 202 && time > 2 && movecontact
