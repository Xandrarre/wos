...
;CS2 Finisher 4
[State -1, CS2 Finisher 4]
type = ChangeState
value = cond(pos y = 0,227,237)
;PLAYER
...
triggerall = stateno != [237,238]
triggerall = var(48) >= 0
triggerall = stateno != 280 && stateno != [266,268]
triggerall = stateno != 290
triggerall = var(0) = 1

;CS2 Finisher 3
[State -1, CS2 Finisher 3]
type = ChangeState
value = cond(pos y = 0,265,237)
;PLAYER
...
;CS2 Finisher 2
[State -1, CS2 Finisher 2]
type = ChangeState
value = cond(pos y = 0,248,237)
;PLAYER
...
;CS2 Finisher 1
[State -1, CS2 Finisher 1]
type = ChangeState
value = cond(pos y = 0,217,237)
;PLAYER
...
trigger3 = stateno = [10200,10299]
trigger3 = movecontact

;Cursed Seal Stage 2
[State -1, Cursed Seal Stage 2]
type = ChangeState
value = 1000
;PLAYER
...
trigger1 = var(50) = 0
;AI RANDOM
trigger2 = random = [900,901+(var(49)*((var(5)/100)+var(49)))/1000+(var(5)/500)]
trigger2 = var(50) = 1
;WARUNEK
...
;Ultimate: Taren Fujizuho
[State -1, Ultimate: Taren Fujizuho]
type = ChangeState
value = 400
;PLAYER
...
;WARUNEK
trigger1 = stateno = 70850 && time > cond(prevstateno=0,5,0) && (pos y = 0 && statetype != A)
trigger2 = (var(50) = 1 && pos y = 0 && statetype != A && ctrl) || (var(48) >= 0 && var(50) = 1 && pos y = 0 && statetype != A && movecontact && stateno = [200,299]) 
...
trigger2 = p2dist y = [-50,50]
trigger2 = random = [620,621+var(49)*((power/400)+var(49))/500+power/400+var(48)/200]
trigger2 = var(50) = 1
trigger2 = p2stateno != [5110,5150]
;FURIA
trigger3 = p2dist x = [250,400]
trigger3 = p2dist y = [-50,50]
trigger3 = random = [620,621+var(19)]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 500
;WARUNEK
trigger1 = stateno = 70850 && time > cond(prevstateno=0,5,0) && (pos y = 0 && statetype != A)
trigger2 = (var(50) = 1 && pos y = 0 && statetype != A && ctrl) || (var(48) >= 0 && var(50) = 1 && pos y = 0 && statetype != A && movecontact && stateno = [200,299]) 
trigger3 = (pos y = 0 && statetype != A && ctrl) || (var(48) >= 0 && pos y = 0 && statetype != A && movecontact && stateno = [200,299])
...
trigger3 = p2dist y = [-50,50]
trigger3 = random = [600,601+var(19)]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 500
;WARUNEK
trigger1 = stateno = 70850 && time > cond(prevstateno=0,5,0) && (pos y = 0 && statetype != A)
...
;FURIA
trigger3 = p2dist x = [0,100]
trigger3 = p2dist y = [-50,250]
trigger3 = random = [560,561+var(19)]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 500
;WARUNEK
trigger1 = stateno = 70850 && time > cond(prevstateno=0,5,0) && (pos y != 0 && statetype = A)
...
trigger2 = p2stateno != [5110,5150]
;FURIA
trigger3 = p2dist x = [50,150]
trigger3 = p2dist y = [-50,50]
trigger3 = random = [540,541+var(19)]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 500
;WARUNEK
trigger1 = stateno = 70850 && time > cond(prevstateno=0,5,0) && (pos y = 0 && statetype != A)
...
trigger3 = p2dist y = [-50,50]
trigger3 = random = [520,521+var(19)]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 500
;WARUNEK
trigger1 = stateno = 70850 && time > cond(prevstateno=0,5,0) && (pos y = 0 && statetype != A)
...
;Kassokuken: Ichishiki Down
[State -1, Kassokuken: Ichishiki Down]
type = ChangeState
value = 350
;PLAYER
trigger1 = command = "hold_c"
...
trigger3 = p2dist y = [-50,50]
trigger3 = random = [500,501+var(19)]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 500
;WARUNEK
trigger1 = stateno = 70850 && time > cond(prevstateno=0,5,0) && (pos y = 0 && statetype != A)
...
trigger3 = p2dist y = [-50,50]
trigger3 = random = [440,441+var(19)]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 500
;WARUNEK
trigger1 = stateno = 70850 && time > cond(prevstateno=0,5,0) && (pos y = 0 && statetype != A)
...
trigger3 = p2dist x = [0,50]
trigger3 = p2dist y = [-50,50]
trigger3 = random = [420,421+var(19)]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 500
;WARUNEK
trigger1 = stateno = 70850 && time > cond(prevstateno=0,5,0) && (pos y = 0 && statetype != A)
...
trigger3 = p2dist x = [0,50]
trigger3 = p2dist y = [-50,50]
trigger3 = random = [400,401+var(19)]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 500
;WARUNEK
trigger1 = stateno = 70850 && time > cond(prevstateno=0,5,0) && (pos y = 0 && statetype != A)
...
trigger3 = p2dist x = [0,100]
trigger3 = p2dist y = [-50,50]
trigger3 = random = [140,141+var(19)*2]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 200
;WARUNEK
triggerall = stateno = 267 && time > 15

;CS2 Combo 7
[State -1, CS2 Combo 7.2]
type = ChangeState
value = 266
;PLAYER
trigger1 = command = "x" && command = "holdfwd"
...
trigger3 = var(5) > 200
;WARUNEK
triggerall = stateno = 265 && time > 13 && movecontact

;CS2 Combo 6
[State -1, CS2 Combo 6.3]
type = ChangeState
value = 257
;PLAYER
...
trigger3 = p2dist y = [-50,50]
trigger3 = random = [200,201+var(19)*2]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 200
;WARUNEK
triggerall = stateno = 256 && time > 3 && movecontact

;CS2 Combo 6
[State -1, CS2 Combo 6.2]
type = ChangeState
value = 256
;PLAYER
trigger1 = command = "x" && command = "holddown"
...
trigger3 = var(5) > 200
;WARUNEK
triggerall = stateno = 255 && time > 29 && movecontact

;CS2 Combo 5
[State -1, CS2 Combo 5.4]
type = ChangeState
value = 248
;PLAYER
trigger1 = command = "x"
...
trigger3 = p2dist x = [0,80]
trigger3 = p2dist y = [-50,50]
trigger3 = random = [180,181+var(19)*2]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 200
;WARUNEK
triggerall = stateno = 247 && time > 3 && movecontact

;CS2 Combo 5
[State -1, CS2 Combo 5.3]
type = ChangeState
value = 247
;PLAYER
trigger1 = command = "x"
...
trigger3 = var(5) > 200
;WARUNEK
triggerall = stateno = 246 && time > 6 && movecontact

;CS2 Combo 5
[State -1, CS2 Combo 5.2]
type = ChangeState
value = 246
;PLAYER
trigger1 = command = "x"
...
trigger3 = var(5) > 200
;WARUNEK
triggerall = stateno = 245 && time > 3 && movecontact

;CS2 Combo 4
[State -1, CS2 Combo 4.3]
type = ChangeState
value = 237
;PLAYER
...
;FURIA
trigger3 = p2dist x = [0,100]
trigger3 = p2dist y = [-50,150]
trigger3 = random = [160,161+var(19)*2]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 200
;WARUNEK
triggerall = stateno = 236 && time > 3 && movecontact

;CS2 Combo 4
[State -1, CS2 Combo 4.2]
type = ChangeState
value = 236
;PLAYER
trigger1 = command = "a" || command = "x"
...
trigger3 = var(5) > 200
;WARUNEK
triggerall = stateno = 235 && time > 3 && movecontact

;CS2 Combo 3
[State -1, CS2 Combo 3.3]
type = ChangeState
value = 227
;PLAYER
...
trigger3 = var(5) > 200
;WARUNEK
triggerall = stateno = 226 && time > 5 && movecontact

;CS2 Combo 3
[State -1, CS2 Combo 3.2]
type = ChangeState
value = 226
;PLAYER
trigger1 = command = "a" && command = "holdfwd"
...
trigger3 = var(5) > 200
;WARUNEK
triggerall = stateno = 225 && time > 3 && movecontact


;CS2 Combo 2
[State -1, CS2 Combo 2.3]
type = ChangeState
value = 217
;PLAYER
...
trigger3 = p2dist x = [0,80]
trigger3 = p2dist y = [-70,50]
trigger3 = random = [120,121+var(19)*2]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 200
;WARUNEK
triggerall = stateno = 216 && time > 6 && movecontact

;CS2 Combo 2
[State -1, CS2 Combo 2.2]
type = ChangeState
value = 216
;PLAYER
trigger1 = command = "a" && command = "holddown"
...
trigger3 = var(5) > 200
;WARUNEK
triggerall = stateno = 215 && time > 3 && movecontact

;CS2 Combo 1
[State -1, CS2 Combo 1.4]
type = ChangeState
value = 208
;PLAYER
trigger1 = command = "a"
...
trigger3 = p2dist x = [0,50]
trigger3 = p2dist y = [-50,50]
trigger3 = random = [100,101+var(19)*2]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 200
;WARUNEK
triggerall = stateno = 207 && time > 3 && movecontact

;CS2 Combo 1
[State -1, CS2 Combo 1.3]
type = ChangeState
value = 207
;PLAYER
trigger1 = command = "a"
...
trigger3 = var(5) > 200
;WARUNEK
triggerall = stateno = 206 && time > 3 && movecontact

;CS2 Combo 1
[State -1, CS2 Combo 1.2]
type = ChangeState
value = 206
;PLAYER
trigger1 = command = "a"
...
trigger3 = var(5) > 200
;WARUNEK
triggerall = stateno = 205 && time > 3 && movecontact
...
trigger3 = p2dist x = [0,50]
trigger3 = p2dist y = [-50,50]
trigger3 = random = [280,281+var(19)]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 200
;WARUNEK
triggerall = ctrl || (var(48) >= 0 && movecontact && stateno = [200,299])
...
trigger3 = p2dist x = [0,70]
trigger3 = p2dist y = [-50,50]
trigger3 = random = [260,261+var(19)]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 200
;WARUNEK
triggerall = ctrl || (var(48) >= 0 && movecontact && stateno = [200,299])
...
trigger3 = p2dist x = [0,50]
trigger3 = p2dist y = [-50,50]
trigger3 = random = [220,221+var(19)]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 200
;WARUNEK
trigger1 = (pos y = 0 && statetype = S && ctrl) || stateno = 20 || stateno = 100
trigger2 = (pos y = 0 && statetype = S && ctrl) || stateno = 20 || stateno = 100
trigger3 = (pos y = 0 && statetype = S && ctrl) || stateno = 20 || stateno = 100
...
trigger3 = p2dist x = [0,50]
trigger3 = p2dist y = [-50,50]
trigger3 = random = [200,201+var(19)]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 200
;WARUNEK
...
trigger3 = p2dist x = [0,50]
trigger3 = p2dist y = [-50,50]
trigger3 = random = [160,161+var(19)]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 200
;WARUNEK
...
trigger3 = p2dist x = [0,50]
trigger3 = p2dist y = [-50,50]
trigger3 = random = [140,141+var(19)]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 200
;WARUNEK
trigger1 = (pos y = 0 && statetype = S && ctrl) || stateno = 20 || stateno = 100
...
trigger3 = p2dist x = [0,50]
trigger3 = p2dist y = [-50,50]
trigger3 = random = [120,121+var(19)]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 200
;WARUNEK
trigger1 = (pos y = 0 && statetype = C && ctrl)
...
trigger3 = p2dist x = [0,50]
trigger3 = p2dist y = [-50,50]
trigger3 = random = [100,101+var(19)]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 200
;WARUNEK
trigger1 = (pos y = 0 && statetype = S && ctrl)
...
trigger3 = p2dist x = [0,50]
trigger3 = p2dist y = [-50,50]
trigger3 = random = [240,241+var(19)*2]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 200
;WARUNEK
triggerall = stateno = 273 && time > 5
...
trigger3 = p2dist x = [0,100]
trigger3 = p2dist y = [-70,50]
trigger3 = random = [220,221+var(19)*2]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 200
;WARUNEK
...
trigger3 = var(5) > 200
;WARUNEK
triggerall = stateno = 260 && time > 5 && movecontact
...
trigger3 = var(5) > 200
;WARUNEK
triggerall = stateno = 241 && time > 5 && movecontact
...
trigger3 = var(5) > 200
;WARUNEK
triggerall = stateno = 221 && time > 13 && movecontact
...
trigger3 = var(5) > 200
;WARUNEK
triggerall = stateno = 202 && time > 9 && movecontact
...
trigger2 = p2dist x = [0,50]
trigger2 = p2dist y = [-50,50]
trigger2 = random = [240,161+var(49)*(var(49))/50+10-var(48)/50]
trigger2 = var(50) = 1
trigger2 = p2stateno != [5110,5150]
;FURIA
trigger3 = p2dist x = [0,50]
trigger3 = p2dist y = [-50,50]
trigger3 = random = [240,161+var(19)]
trigger3 = p2stateno != [5110,5150]
trigger3 = var(5) > 200
;WARUNEK
trigger1 = (pos y != 0 && statetype = A && ctrl)
...
trigger3 = (pos y = 0 && statetype = S && ctrl) || stateno = 100
triggerall = stateno != [260,269]
triggerall = var(0) = 0
;triggerall = var(48) < 350
...
;FURIA
trigger3 = p2dist x = [0,50]
trigger3 = random = [40,41+var(19)/2]
trigger3 = var(5) > 200
;WARUNEK
triggerall = ctrl
triggerall = pos y < -30 
...
trigger3 = random = [30,31+var(19)/2]
trigger3 = var(5) > 200
;WARUNEK
triggerall = ctrl
triggerall = pos y < -30 
...
;FURIA
trigger2 = p2dist x > 100
trigger3 = random = [30,39+var(19)+(p2bodydist x)/100]
trigger3 = var(5) > 200
;WARUNEK
triggerall = pos y != 0 && statetype = A && ctrl
...
[State -1, Run Fwd]
type = ChangeState
value = cond(var(0)=0,100,101)
;PLAYER
trigger1 = command = "FF"
trigger1 = var(50) = 0
;AI RANDOM
trigger2 = var(50) = 1
trigger2 = p2dist x > cond(var(0) = 0,20,150)
trigger2 = random = [10,19+var(49)*(var(49))/500+(p2bodydist x)/100]
;FURIA
trigger3 = p2dist x > cond(var(0) = 0,20,150)
trigger3 = random = [10,19+var(19)/5+(p2bodydist x)/100]
trigger3 = var(5) > 200
;WARUNEK
triggerall = ((pos y = 0 && statetype = S)) && ctrl
...
;FURIA
trigger2 = (p2dist y < -30 && enemynear, vel y < 0)
trigger2 = random = [10,11+var(19)+(-p2bodydist y)/200]
trigger2 = var(5) > 200
;WARUNEK
triggerall = ((pos y != 0 && statetype = A)) && ctrl
triggerall = prevstateno = 40
...
;FURIA
trigger2 = (p2dist y < -40 && enemynear, vel y < 0) || (p2movetype = A && p2bodydist x = [50,150])
trigger2 = random = [30,31+var(19)+(-p2bodydist y)/200+cond(p2movetype = A,var(19),0)]
trigger2 = var(5) > 200
;WARUNEK
triggerall = ((pos y = 0 && statetype = S)) && ctrl
...
trigger2 = random = [10,19+var(19)+(p2bodydist x)/50]
trigger2 = var(5) > 200
;WARUNEK
triggerall = pos y = 0 && statetype = S && ctrl
triggerall = var(0) = 1
