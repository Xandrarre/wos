...
trigger2 = p2stateno != [5110,5150]
;WARUNEK
triggerall = stateno = 233 && time > 4 && movecontact
...
trigger2 = p2stateno != [5110,5150]
;WARUNEK
triggerall = stateno = 232 && time > 4 && movecontact
...
trigger1 = var(50) = 0
;AI RANDOM
trigger2 = p2dist x = [0,180]
trigger2 = p2dist y = [-80,50]
trigger2 = random = [140,141+var(49)*(var(49)/20)+10+var(48)/40]
trigger2 = var(50) = 1
trigger2 = p2stateno != [5110,5150]
;WARUNEK
triggerall = stateno = 224 && time > 15 && movecontact
...
trigger2 = p2stateno != [5110,5150]
;WARUNEK
triggerall = stateno = 223 && time > 15 && movecontact
...
trigger2 = p2stateno != [5110,5150]
;WARUNEK
triggerall = stateno = 204 && time > 4 && movecontact
...
trigger2 = p2stateno != [5110,5150]
;WARUNEK
triggerall = stateno = 203 && time > 5 && movecontact
